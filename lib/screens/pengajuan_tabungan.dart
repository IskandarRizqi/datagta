...
class PengajuanTabungan extends StatefulWidget {
  @override
  State<PengajuanTabungan> createState() => _PengajuanTabunganState();
}

class _PengajuanTabunganState extends State<PengajuanTabungan> {
  ...
  final GlobalKey<FormState> tabungan = GlobalKey();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20),
                Image.network(
                  'https://res.cloudinary.com/dvwsffyzc/image/upload/v1694767488/Rectangle_410_3_htbfb8.png',
                  width: 200,
                  height: 200,
                  fit: BoxFit.cover,
                ),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FormBuilderTextField(
                            ...
                            initialValue: setoran_awal,
                            decoration: InputDecoration(
                              labelText: "Setoran Awal (Rp)",
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(25)),
                            ),
                            validator: (val) {
                              ...
                              setoran_awal = val.toString();
                              return null;
                            },
                            onChanged: (value) {
                              setoran_awal = value.toString();
                            },
                          ),
                        ),
                      ],

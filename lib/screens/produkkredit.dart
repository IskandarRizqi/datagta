import 'package:apm/screens/detailkredit.dart';
import 'package:flutter/material.dart';

import '../model/produkkreditmodel.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Kredit'), // Judul AppBar
            ...
            Expanded(
              child: GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2),
                itemCount: Kredit.kredits.length,
                itemBuilder: (ctx, index) {
                  final kredit = Kredit.kredits[index];
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => DetailKreditPage(kredits: kredit),
                        ),
                      );
                    },

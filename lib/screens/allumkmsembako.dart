...
class AllSembako extends StatefulWidget {
  const AllSembako({super.key});

  @override
  State<AllSembako> createState() => _AllSembakoState();
}

class _AllSembakoState extends State<AllSembako> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF00923F), // Warna latar belakang AppBar
        title: Text(' Semua Sembako'), // Judul AppBar
          ...
          children: [
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemCount: UmkmSembako.umkmsembakos.length,

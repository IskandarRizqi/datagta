...
class AllKendaraan extends StatefulWidget {
  const AllKendaraan({super.key});

  @override
  State<AllKendaraan> createState() => _AllKendaraanState();
}

class _AllKendaraanState extends State<AllKendaraan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF00923F), // Warna latar belakang AppBar
        title: Text(' Semua Kendaraan'), // Judul AppBar
          ...
          children: [
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemCount: UmkmKendaraan.umkmkendaraans.length,
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => DetailUmkmKendaraan(
                              umkmkendaraans: umkmkendaraan),
                        ),
                      );
                    },
                    child: _buildProductCard(
                      umkmkendaraan.imageUrl,
                      umkmkendaraan.title,
                      umkmkendaraan.description,
                    ),
                  );
                },
              ),
